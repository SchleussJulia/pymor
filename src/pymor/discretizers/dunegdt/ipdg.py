...
if config.HAVE_DUNEGDT:
    ...
    def _IP_estimate_penalty_parameter(grid, space, symmetry_factor, diffusion_min_max_parametric_part=None):
        if symmetry_factor == -1:  # NIPDG
            ...
            if diffusion_min_max_parametric_part is not None:
                penalty_parameter = C_G * C_M_times_1_plus_C_T * diffusion_min_max_parametric_part[1]**2 / diffusion_min_max_parametric_part[0]
            else:
